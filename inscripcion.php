...
// header("location:index.php");
 ...
 //{
  ...
  $message .= "<img src='https://prueba-cega.000webhostapp.com/donar/img/contact.jpg' height='200' width='1200'  style='margin-left: 15px;'/>
          <p style='text-align:center; margin-top: 50px; font-size: 50px;'>HOLA, <b style='text-transform: uppercase; font-size: 50px;'>".$nombre."  </b> </p>
          <p style='text-align: center; font-weight: bold; font-size: 30px;'>Gracias por suscripbirte, pronto nos comunicaremos con usted.  </p>
 ...
 /*}
  ...
  $_SESSION['inscripcion'] = 1;
  mysqli_query($conexion,"insert into inscripcion (nombre, correo, celular, departamento, municipio, donacion, fecha) values ('$_POST[nombre]', '$_POST[correo]', $_POST[celular], '$_POST[departamento]', '$_POST[municipio]', $_POST[donacion], '$fecha')"); 
  header("location:index.php");
